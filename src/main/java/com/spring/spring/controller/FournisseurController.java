...
public class FournisseurController {
    ...
    public void init() {
        ...
        UPDATE_QUOTATION_ITEM_URL = erpnextApiUrl + "/api/method/erpnext.services.fournisseur.fournisseur_service.update_quotation_item";
    }

    @GetMapping("/devis")
    public String getFournisseurDevis(Model model, HttpSession session) {
    ...
    public String updateRate(
        ...
        try {
            ...
            if (!headers.containsKey("Authorization")) {
                ...
                return "redirect:/api/spring/fournisseur/devis/update?quotationName=" + quotationName + 
                       "&itemCode=" + itemCode + 
                       "&rate=" + rate + 
                       "&qty=0&amount=0";
            }
            ...
            if (response.getStatusCode().is2xxSuccessful() && status.equals("success")) {
                ...
                return "redirect:/api/spring/fournisseur/devis";
            } else {
